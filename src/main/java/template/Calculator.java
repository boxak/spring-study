...
import template.callback.LineCallback;
...
public class Calculator {
    public Integer calcSum(String filepath) throws IOException {
        LineCallback<Integer> sumCallback = new LineCallback<Integer>() {
            @Override
            public Integer workWithLine(String line, Integer value) {
    ...
    public String concatenate(String filepath) throws IOException {
        LineCallback<String> concatenateCallback = new LineCallback<String>() {
            @Override
            public String workWithLine(String line, String value) {
                return value + line;
            }
        };
    ...
    public <T> T lineReadTemplate(String filepath, LineCallback<T> callback, T initVal)
        ...
        try {
            ...
            while((line = br.readLine()) != null) {
                res = callback.workWithLine(line, res);
            }
